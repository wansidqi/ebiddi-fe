      ...
      <div className="text-[#2C3E50] arial report-layout text-left my-7 overflow-auto">
          ...
          <div className="flex my-1 gap-5 w-[95%]">
            ...
            <section className="flex w-full flex-col gap-1">
              ...
              <SingleColInFlex
                value={[
                  "Alternator",
                  tickbox(report?.withalternator) +
                    report?.withalternatorremarks,
                ]}
              />
              <SingleColInFlex
                value={[
        ...
        <main className="ml-2 text-[11px]">
          ...
          <div className="flex my-1 gap-5 w-[95%]">
            ...
            <section className="flex w-full flex-col gap-1">
              <SingleColInFlex
                value={[
                  "Meter Gauge",
                  tickbox(report?.withmetergauge) +
                    report?.withmetergaugeremarks,
                ]}
              />
              <SingleColInFlex
                value={[
          ...
          <Cols3AllUnderline
            ...
            value2={
              "CD " +
              tickbox(report?.withplayercd) +
              report?.withplayercdremarks
            }
            value3={
              "Monitor " +
        ...
        <main className="ml-2 text-[11px]">
          ...
          <div className="flex my-1 gap-5 w-[95%]">
            ...
            <section className="flex w-full flex-col gap-1">
              ...
              <SingleColInFlex
                value={[
                  "Back Bumper",
                  tickbox(report?.withbackbumper) +
                    report?.withbackbumperremarks,
                ]}
              />
              <Cols2Side
                title="Antena"
              ...
              <Cols2Side
                ...
                value1={[
                  "L",
                  tickbox(report?.withfrontlampl) +
                    report?.withfrontlamplremarks,
                ]}
                value2={[
                  "R",
                  tickbox(report?.withfrontlampr) +
                    report?.withfrontlamprremarks,
                ]}
              />
              <Cols2Side
                title="Wind Screen"
          ...
          <Cols4Value
            title="Rim"
            value1={
              "FL " + tickbox(report?.withrimfl) + report?.withrimflremarks
            }
            value2={
              "FR " + tickbox(report?.withrimfr) + report?.withrimfrremarks
            }
            value3={
              "BL " + tickbox(report?.withrimbl) + report?.withrimblremarks
            }
            value4={
              "BR " + tickbox(report?.withrimbr) + report?.withrimbrremarks
            }
          />
          <Cols4Value
            title="Window Glass"
